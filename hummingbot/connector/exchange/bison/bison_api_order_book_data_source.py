...
from hummingbot.connector.exchange.bison.bison_order_book import BisonOrderBook
...
if TYPE_CHECKING:
    from hummingbot.connector.exchange.bison.bison_exchange import BisonExchange


class BisonAPIOrderBookDataSource(OrderBookTrackerDataSource):
    def __init__(
        self,
        trading_pairs: List[str],
        connector: "BisonExchange",
    ...
    async def _order_book_snapshot(self, trading_pair: str) -> OrderBookMessage:
        ...
        snapshot_msg: OrderBookMessage = BisonOrderBook.snapshot_message_from_exchange_rest(
    ...
    async def _parse_trade_message(self, raw_message: Dict[str, Any], message_queue: asyncio.Queue):
        ...
        trade_message: OrderBookMessage = BisonOrderBook.trade_message_from_exchange(raw_message, metadata=metadata)
    ...
    async def _parse_order_book_diff_message(self, raw_message: Dict[str, Any], message_queue: asyncio.Queue):
        ...
        metadata = {"trading_pair": trading_pair}
        order_book_message: OrderBookMessage = BisonOrderBook.diff_message_from_exchange(
