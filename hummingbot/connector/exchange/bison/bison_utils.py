...
def market_to_trading_pair(market: str) -> str:
    """Converts a market symbol from Bison to a trading pair."""
...
OTHER_DOMAINS = ["bison_testnet"]
OTHER_DOMAINS_PARAMETER = {"bison_testnet": "bison_testnet"}
OTHER_DOMAINS_EXAMPLE_PAIR = {"bison_testnet": "WBTC-USDC"}
OTHER_DOMAINS_DEFAULT_FEES = {"bison_testnet": DEFAULT_FEES}

OTHER_DOMAINS_KEYS = {"bison_testnet": BisonTestnetConfigMap.construct()}
